<template>
	<view class="detail">
		...
		<view class="bottom">
			<view :class="flag ? 'active' : ''" class="like" @click="like">收藏</view>
			<view class="share" @click="share" :data-clipboard-text="url">分享</view>
		</view>
	</view>
</template>
...
<script>
	...
	export default {
		...
		methods: {
			...
			share() {
				this.url = "点击链接看来自" + this.data.name +
					"创作的《" + this.data.ntitle + `》
——————
