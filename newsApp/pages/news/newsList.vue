<template>
	<view>
		<myNewsList @change="getNewsList" :maxIndex="maxIndex" :news="news" ref="newsListRef"></myNewsList>

		<view v-if="flag=='history'" class="btn" @click="clear">清空历史浏览</view>
	</view>
</template>
	...
	export default {
		...
		methods: {
			...
			async getNewsList() {
				...
				if (this.title != "历史浏览") this.news = [...this.news, ...res.data]
			}
		}
	}
</script>
